...
const AppToGraduate = () => {
    ...
    return (
        <div className="atg__main_description">
            ...
            <div className="atg__description">
                <h4><a href="https://www.dlsu.edu.ph/wp-content/uploads/pdf/registrar/schedules/application-graduate-ug.pdf"><u>https://www.dlsu.edu.ph/wp-content/uploads/pdf/registrar/schedules/application-graduate-ug.pdf</u></a></h4>
            </div>
            <div className="atg__description">
            ...
            <div className="atg__description">
                ...
                <br></br>
                <h4><a href="https://www.dlsu.edu.ph/wp-content/uploads/pdf/registrar/schedules/application-graduate-gs.pdf"><u>https://www.dlsu.edu.ph/wp-content/uploads/pdf/registrar/schedules/application-graduate-gs.pdf</u></a></h4>
            </div>
            <div className="atg__description">
            ...
            <div className="atg__description">
                ...
                <h4>2. For questions or concerns, please send an email to <a href="registrar@dlsu.edu.ph"><u>registrar@dlsu.edu.ph</u></a>. In sending an email, we highly encourage you to use the subject heading: <strong>"XXXTH_CE_APPLICATION_TO_GRADUATE"</strong></h4>
            </div>
