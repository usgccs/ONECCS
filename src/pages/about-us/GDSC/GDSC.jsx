...
import {
  ...
  const GDSC = () => { // TODO: Change this to your organization name
    const orgKey = "GDSC"; // TODO: Change this to your orgKey
    ...
    return (
      <div className="header_main_gdsc">
  ...
  export default GDSC; // TODO: Change this to your organization name
