...
import {
  ...
  const CATCH2T24 = () => { // TODO: Change this to your organization name
    const orgKey = "CATCH2T24"; // TODO: Change this to your orgKey
    ...
    return (
      <div className="header_main_catch2t24">
  ...
  export default CATCH2T24; // TODO: Change this to your organization name
